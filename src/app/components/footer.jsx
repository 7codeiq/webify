        ...
        <div className="cs-fooer_main">
          <div className="container">
            <div className="row">
              <div className="col-lg-3 col-sm-6">
                <div className="cs-footer_item">
                  <div className="cs-text_widget">
                    ...
                    <p>
                      مرحبا بكم في ويبيفاي حيث هنا ستجدون جميع اعمالنا وشركاؤنا
                      المحليين والعالميين نتمنى لكم زيارة مريحة تلبي رغباتكم
                      وتمنحكم ثقتنا ولا تنسو دعمنا على مواقع التواصل الاجتماعي
                    </p>
                  </div>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="cs-footer_item">
                  <h2 className="cs-widget_title">الخدمات</h2>
                  <ul className="cs-menu_widget cs-mp0">
                    <li>
                      <a href="service-details.html">UI/UX تصميم</a>
                    </li>
                    <li>
                      <a href="service-details.html">تصميم الويب</a>
                    </li>
                    <li>
                      <a href="service-details.html">التسويق الالكتروني</a>
                    </li>
                    <li>
                      <a href="service-details.html">تصميم الجرافيك</a>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="col-lg-3 col-sm-6">
                <div className="cs-footer_item">
                  <h2 className="cs-widget_title">اتصل بنا</h2>
                  <ul className="cs-menu_widget cs-mp0">
                    <li>العراق , بغداد , المنصور , شارع الرواد</li>
                    <li>9647733013115+</li>
                    <li>info@webify.com</li>
                  </ul>
                </div>
              </div>
              <div className="col-lg-3 col-sm-6">
                <div className="cs-footer_item">
                  <h2 className="cs-widget_title">أشترك الان</h2>
                  <div className="cs-newsletter cs-style1">
                    ...
                    <div className="cs-newsletter_text">
                      لا تنسى الاشتراك معنا في نشرتنا البريدية لكي يصلك كل ماهو
                      جديد وحصري من ويبيفاي
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="cs-bottom_footer">
            <div className="cs-bottom_footer_left">
              <div className="cs-copyright">Copyright © 2024 webify</div>
            </div>
