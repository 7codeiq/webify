                  ...
                  <ul className="cs-nav_list">
                    ...
                    <li className="menu-item-has-children">
                      ...
                      <ul>
                        ...
                        <li>
                          <Link href="/faq">الاسئلة الاكثر شيوعاً</Link>
                        </li>
                      </ul>
                    </li>
                  </ul>
            ...
            <div className="cs-side_header_box">
              ...
              <div className="cs-newsletter cs-style1">
                ...
                <div className="cs-newsletter_text">
                  ويبيفاي وبأيقاع بغدادي ستبني علامتك التجارية معنا وستتميز بها
                  عن باقي المجالات معاً نحو الافق
                </div>
              </div>
            </div>
            <div className="cs-side_header_box">
