  ...
  return (
    <>
      <>
          ...
          <div className="container">
            <div className="cs-page_heading_in">
              ...
              <ol className="breadcrumb text-uppercase">
                ...
                <li className="breadcrumb-item active">اتصل</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="cs-section_heading cs-style1">
                <h3 className="cs-section_subtitle">الحصول على اتصال</h3>
                <h2 className="cs-section_title">
                هل لديك مشروع <br />
                في ذهنك؟
                </h2>
              </div>
              <div className="cs-height_55 cs-height_lg_30" />
            ...
            <div className="col-lg-6">
              ...
              >
                <input
                  type="hidden"
                  name="access_key"
                  defaultValue="6d7bc3fc-6190-43c5-8298-89ac5ef74213"
                />
                <input
                  type="checkbox"
                  name="botcheck"
                ...
                <input
                  type="hidden"
                  name="subject"
                  defaultValue="Submission from Laralink Template"
                />
                <div className="col-sm-6">
                  <label className="cs-primary_color">الاسم الكامل*</label>
                  <input
                    type="text"
                ...
                <div className="col-sm-6">
                  <label className="cs-primary_color">البريد الإلكتروني*</label>
                  <input
                    type="text"
                    className="cs-form_field"
                    name="email"
                ...
                <div className="col-sm-6">
                  <label className="cs-primary_color">نوع المشروع*</label>
                  <input
                    type="text"
                    className="cs-form_field"
                    name="project"
                ...
                <div className="col-sm-6">
                  <label className="cs-primary_color">رقم الهاتف*</label>
                  <input
                    type="text"
                    className="cs-form_field"
                    name="number"
        ...
        <div className="cs-height_150 cs-height_lg_80" />
        <div className="cs-google_map cs-bg" data-src="assets/img/map_img.jpeg">
          <iframe
