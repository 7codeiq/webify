export default function Service(){
  ...
  >
    <div className="container">
      <div className="cs-page_heading_in">
        <h1 className="cs-page_title cs-font_50 cs-white_color">خدمات</h1>
        <ol className="breadcrumb text-uppercase">
          <li className="breadcrumb-item">
            <a href="index.html">الرئيسية</a>
          </li>
          <li className="breadcrumb-item active">خدمات</li>
        </ol>
      </div>
    </div>
  </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="cs-hobble">
                ...
                >
                  ...
                  <div className="cs-card_info">
                    <span className="cs-hover_layer3 cs-accent_bg" />
                    <h2 className="cs-card_title">تصميم مواقع الويب</h2>
                  </div>
                </a>
              </div>
              <div className="cs-height_0 cs-height_lg_30" />
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="cs-hobble">
                ...
                >
                  ...
                  <div className="cs-card_info">
                    <span className="cs-hover_layer3 cs-accent_bg" />
                    <h2 className="cs-card_title">تطوير المشاريع</h2>
                  </div>
                </a>
              </div>
              <div className="cs-height_0 cs-height_lg_30" />
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="cs-hobble">
                ...
                >
                  ...
                  <div className="cs-card_info">
                    <span className="cs-hover_layer3 cs-accent_bg" />
                    <h2 className="cs-card_title">هوية بصرية</h2>
                  </div>
                </a>
              </div>
              <div className="cs-height_0 cs-height_lg_30" />
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="cs-hobble">
                ...
                >
                  ...
                  <div className="cs-card_info">
                    <span className="cs-hover_layer3 cs-accent_bg" />
                    <h2 className="cs-card_title">تصميم الجرافيك</h2>
                  </div>
                </a>
              </div>
              <div className="cs-height_0 cs-height_lg_30" />
    ...
    <div className="container">
      <div className="cs-tabs cs-style1">
        <div className="cs-tabs_heading">
          <div className="cs-section_heading cs-style1">
            <h3 className="cs-section_subtitle">التسعير والتعبئة والتغليف</h3>
            <h2 className="cs-section_title">
              تقديم أفضل <br />
              الأسعار للعميل
            </h2>
        ...
        {/* .cs-tabs_heading */}
        <div className="cs-height_85 cs-height_lg_40" />
        <div className="cs-tab_body">
          <div className="cs-tab" id="tab_1">
            <div className="row">
              <div className="col-lg-4">
                <div className="cs-pricing_table cs-style1">
                  <h2 className="cs-pricing_title">الاعتيادي</h2>
                  <div className="cs-pricing_info">
                    <div className="cs-price">
                      <h3 className="cs-white_color">$59/</h3>
                      <span className="cs-accent_color">سنوي</span>
                    </div>
                    <div className="cs-price_text">لكل مشترك في السنة</div>
                  </div>
                  <ul className="cs-pricing_feature cs-mp0">
                    ...
                    <li>
                      ...
                      <span>البحث عن الكلمات المفتاحية</span>
                    </li>
                    <li>
                      <span className="cs-feature_icon cs-accent_color">
                        <svg
                    ...
                    <li>
                      ...
                      <span>حل التجارة الإلكترونية</span>
                    </li>
                    <li>
                      <span className="cs-feature_icon cs-accent_color">
                        <svg
              ...
              <div className="col-lg-4">
                <div className="cs-pricing_table cs-style1">
                  <h2 className="cs-pricing_title">محترف</h2>
                  <div className="cs-pricing_info">
                    <div className="cs-price">
                  ...
                  <ul className="cs-pricing_feature cs-mp0">
                    ...
                    <li>
                      ...
                      <span>كلمات رئيسية عالية الجودة</span>
                    </li>
                    <li>
                      <span className="cs-feature_icon cs-accent_color">
                        <svg
              ...
              <div className="col-lg-4">
                <div className="cs-pricing_table cs-style1">
                  <h2 className="cs-pricing_title">النهائي</h2>
                  <div className="cs-pricing_info">
                    <div className="cs-price">
                  ...
                  <ul className="cs-pricing_feature cs-mp0">
                    <li>
                      ...
                      <span>موقع ويب ديناميكي سريع الاستجابة</span>
                    </li>
                    <li>
                      <span className="cs-feature_icon cs-accent_color">
                        <svg
  ...
  {/* End Pricing Plan */}
  <div className="cs-height_125 cs-height_lg_55" />
